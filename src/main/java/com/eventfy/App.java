...
public class App {
     ...
     * 
     * System.out.
     * println("Qual è la capienza minima dell'impianto in cui vuoi esibirti?");
     * while (!input.hasNextInt()) {
     * System.out.println("Inserisci un numero intero, riprova");
     * input.next();
     * }
     ...
     * 
     * System.out.
     * println("Quando vuoi esibirti? Inserisci la data nel formato dd.mm.yyyy");
     ...
     * System.out.println("");
     * System.out.
     * println("Inserisci l'ID dell'impianto di cui vuoi richiedere la prenotazione"
     * );
     * while (!input.hasNextInt()) {
     * System.out.println("Inserisci un numero intero, riprova");
     * input.next();
     ...
     * List<Prenotazione> prenotazioniPendenti =
     * sistema.mostraPrenotazioniPendenti();
     ...
     * }
     * System.out.
     * println("Inserisci il codice della prenotazione per cui desideri inviare un invito:"
     * );
     * int codice_prenotazione = input.nextInt();
     * input.nextLine();
     * List<Utente> artistiDisponibili =
     * sistema.selezionaPrenotazioneInvito(codice_prenotazione);
     ...
     * System.out.
     * println("Inserisci il codice della prenotazione per cui vuoi scrivere una recensione:"
     * );
     * int codice_prenotazione = input.nextInt();
     ...
     * 
     * System.out.
     * println("Inserisci il codice della prenotazione che vuoi eliminare:");
     * int codice_prenotazione = input.nextInt();
     * 
     ...
     * } else {
     * System.out.
     * println("Solo un artista può eliminare una prenotazione di una struttura");
     * }
     * menu();
     * }
     * }
     ...
     * sistema.partecipaEvento(codice_artista);
     * System.out.println("Prenotazioni partecipabili:");
     * for (Prenotazione p : prenotazioniPartecipabili) {
     * System.out.println(p);
     * }
     * System.out.
     * println("Inserisci il codice della prenotazione a cui vuoi partecipare:");
     * int codice_prenotazione = input.nextInt();
     ...
     * }
     * System.out.
     * print("Inserisci l'id dell'evento per cui vuoi scrivere una recensione: ");
     ...
     * System.out.print("Inserisci il voto (da 1 a 5): ");
     * int voto = input.nextInt();
